...
1. Create an [AWS account](https://aws.amazon.com/resources/create-account/):
  ...
  * The email can be either:
  1. A shared GA mailbox (contact the Service Desk - note that this can take some time to create), OR
  2. ga.autobots+______@gmail.com (e.g. ga.autobots+bumblebee@gmail.com). Email from this account forwards to the Autobots
