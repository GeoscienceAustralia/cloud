...
If you're running a production system, you should include a runbook in your repository alongside your application code and infrastructure code. That way it's stored and version-controlled alongside the application it describes.
